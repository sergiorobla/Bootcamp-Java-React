...
console.log(" ");
const frase: string = "Hola el otro dia me encontré con un oso hormiguero.";
const letra: string = "o";
function encontrarLetra(frase: string, letra: string) {
...
console.log(
  "devuelva la misma cadena pero con los caracteres en orden inverso."
);
console.log(" ");
function fraseAlReves(frase: string) {
  let fraseInvertida = "";
...
console.log(" ");
function eliminarEspacios(frase: string) {
  const espacio = " ";
...
console.log(" ");
function contarPalabras(frase: string) {
...
console.log(" ");
const palabra: string = "aca";
function verificarPalindromo(palabra: string) {
...
function ponerMayuscula(frase: string) {
...
console.log(" ");
function contarVocalesConsonantes(frase: string) {
  const vocales = [
    "a",
    "á",
    "à",
